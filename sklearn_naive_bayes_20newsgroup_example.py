...
def newsgroup_example():
    ...
    # ---------------------------------------------
    run_button_key = 'newsgroups_load_run_button'
    ...
    # -----------------------------------------------------
    run_button_key = 'newsgroups_load_options_run_button'
    code_col, output_col = st.beta_columns(2)
    with code_col:
        st.subheader('Code:')
        st.write(
    ...
    # --------------------------------------
    run_button_key = 'newsgroups_CountVectorizer_run_button'
    code_col, output_col = st.beta_columns(2)
    with code_col:
        st.subheader('Code:')
        st.write(
    ...
    # --------------------------------------------------
    run_button_key = 'newsgroups_CountVectorizer_ngram_range_run_button'
    ...
    # -------------------------------------------------------------
    run_button_key = 'newsgroups_CountVectorizer_feature_limits_run_button'
    ...
    # ------------------------------------------------------
    run_button_key = 'newsgroups_TfidfVectorizer_run_button'
    code_col, output_col = st.beta_columns(2)
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        @st.cache
        def countvectorizer_tfidfvectorizer():
            ...
            return corpus, count_vectorizer, X_count, X_tfidf, X_count_df, X_tfidf_df, vocabulary_df
        
        corpus, count_vectorizer, X_count, X_tfidf, X_count_df, X_tfidf_df, vocabulary_df = countvectorizer_tfidfvectorizer()
    ...
    # --------------------------------------------------------
    run_button_key = 'newsgroups_TfidfVectorizer_keyword_arguments_run_button'
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        @st.cache
        def tfidfvectorizer_keyword_arguments(norm_code, use_idf_code, smooth_idf_code, sublinear_tf_code):
            ...
            return corpus, X_tfidf, X_tfidf_df, vocabulary_df
        
        corpus, X_tfidf, X_tfidf_df, vocabulary_df = tfidfvectorizer_keyword_arguments(norm_code, use_idf_code, smooth_idf_code, sublinear_tf_code)
    ...
    # -------------------------------------------------
    run_button_key = 'newsgroups_vectorize_by_category_run_button'
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        @st.cache
        def vectorize_by_category(max_features_val, stop_words_code):
            # Load the 20 newsgroup data
            ...
            for category in newsgroups.target_names:
                ...
                return newsgroups_df, top_features_df, top_features_counts_df
            
        newsgroups_df, top_features_df, top_features_counts_df = vectorize_by_category(max_features_val, stop_words_code)
    ...
    # ----------------------------------------------------------------
    run_button_key = 'newsgroups_vectorize_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        top_features_df = vectorize_newsgroups()
    ...
    # -----------------------------------------------------------------------------    
    run_button_key = 'newsgroups_classifier_baseline_performance_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        @st.cache
        def classifier_baseline_performance():
            # Load 'train' and 'test' data subsets
            newsgroups_train = fetch_20newsgroups(subset='train', shuffle='true', remove=('headers', 'footers', 'quotes'), random_state=42)
            newsgroups_test = fetch_20newsgroups(subset='test', shuffle='true', remove=('headers', 'footers', 'quotes'), random_state=42)
            ...
            baselines = {'MultinomialNB': {}, 'ComplementNB': {}, 'BernoulliNB': {}, 'GaussianNB': {}}

            baselines['MultinomialNB']['CountVectorizer'] = multinomial_counts.score(test_counts, newsgroups_test.target)
            baselines['MultinomialNB']['TfidfVectorizer'] = multinomial_tfidfs.score(test_counts, newsgroups_test.target)

            baselines['ComplementNB']['CountVectorizer'] = complement_counts.score(test_counts, newsgroups_test.target)
            baselines['ComplementNB']['TfidfVectorizer'] = complement_tfidfs.score(test_counts, newsgroups_test.target)

            baselines['BernoulliNB']['CountVectorizer'] = bernoulli_counts.score(test_counts_binary, newsgroups_test.target)

            baselines['GaussianNB']['CountVectorizer'] = 0.5533722782793414
            baselines['GaussianNB']['TfidfVectorizer'] = 0.5509824747742963

            num_features_extracted = len(count_vectorizer.vocabulary_)

            return num_features_extracted, baselines

        num_features_extracted, baselines = classifier_baseline_performance()
        # Print the number of features extracted from the data:
        st.write(f'**Number of features extracted:** {num_features_extracted}')
        ...
        st.write(
            ...
            **Baseline performance accuracies:**
            - `MultinomialNB`
                - `CountVectorizer`: {baselines['MultinomialNB']['CountVectorizer']}
                - `TfidfVectorizer`: {baselines['MultinomialNB']['TfidfVectorizer']}
            - `ComplementNB`
                - `CountVectorizer`: {baselines['ComplementNB']['CountVectorizer']}
                - `TfidfVectorizer`: {baselines['ComplementNB']['TfidfVectorizer']}
            - `BernoulliNB`
                - `CountVectorizer`: {baselines['BernoulliNB']['CountVectorizer']}
            - `GaussianNB`
                - `CountVectorizer`: {baselines['GaussianNB']['CountVectorizer']}
                - `TfidfVectorizer`: {baselines['GaussianNB']['TfidfVectorizer']}
            '''
        )
        '''
    ...
    # -----------------------------------------------------------------------------------------
    run_button_key = 'newsgroups_tuning_classifier_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        def tuning_classifier():
            ...
            return accuracy_df, fig1, fig2, fig3, fig4

        accuracy_df, fig1, fig2, fig3, fig4 = tuning_classifier()
    ...
    # --------------------------------------------------------------------------
    run_button_key = 'newsgroups_baseline_splitting_method_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        def baseline_splitting_method():
            ...
            multinomial_performances = {'subset': {}, 'train_test_split': {}}
            multinomial_performances['subset']['TF'] = multinomial_counts_subset.score(test_counts_subset, newsgroups_test_subset.target)
            multinomial_performances['subset']['TF-IDF'] = multinomial_tfidfs_subset.score(test_tfidfs_subset, newsgroups_test_subset.target)
            multinomial_performances['subset']['TF + TF-IDF'] = multinomial_counts_tfidfs_subset.score(test_counts_tfidfs_subset, newsgroups_test_subset.target)
            multinomial_performances['train_test_split']['TF'] = multinomial_counts_sklearn.score(test_counts_sklearn, newsgroups_test_sklearn.category)
            multinomial_performances['train_test_split']['TF-IDF'] = multinomial_tfidfs_sklearn.score(test_tfidfs_sklearn, newsgroups_test_sklearn.category)
            multinomial_performances['train_test_split']['TF + TF-IDF'] = multinomial_counts_tfidfs_sklearn.score(test_counts_tfidfs_sklearn, newsgroups_test_sklearn.category)

            complement_performances = {'subset': {}, 'train_test_split': {}}
            complement_performances['subset']['TF'] = complement_counts_subset.score(test_counts_subset, newsgroups_test_subset.target)
            complement_performances['subset']['TF-IDF'] = complement_tfidfs_subset.score(test_tfidfs_subset, newsgroups_test_subset.target)
            complement_performances['subset']['TF + TF-IDF'] = complement_counts_tfidfs_subset.score(test_counts_tfidfs_subset, newsgroups_test_subset.target)
            complement_performances['train_test_split']['TF'] = complement_counts_sklearn.score(test_counts_sklearn, newsgroups_test_sklearn.category)
            complement_performances['train_test_split']['TF-IDF'] = complement_tfidfs_sklearn.score(test_tfidfs_sklearn, newsgroups_test_sklearn.category)
            complement_performances['train_test_split']['TF + TF-IDF'] = complement_counts_tfidfs_sklearn.score(test_counts_tfidfs_sklearn, newsgroups_test_sklearn.category)

            return multinomial_performances, complement_performances

        multinomial_performances, complement_performances = baseline_splitting_method()
            ...
            st.write(
                ...
                **MultinomialNB baseline performance accuracies:**
                - Splitting with `subset` keyword argument:
                    - TF vectors: {multinomial_performances['subset']['TF']}
                    - TF-IDF vectors: {multinomial_performances['subset']['TF-IDF']}
                    - TF + TF-IDF vectors: {multinomial_performances['subset']['TF + TF-IDF']}
                - Splitting with `train_test_split`:
                    - TF vectors: {multinomial_performances['train_test_split']['TF']}
                    - TF-IDF vectors: {multinomial_performances['train_test_split']['TF-IDF']}
                    - TF + TF-IDF vectors: {multinomial_performances['train_test_split']['TF + TF-IDF']}
                '''
            )
        with output_col2:
            st.write(
                ...
                **ComplementNB baseline performance accuracies:**
                - Splitting with `subset` keyword argument:
                    - TF vectors: {complement_performances['subset']['TF']}
                    - TF-IDF vectors: {complement_performances['subset']['TF-IDF']}
                    - TF + TF-IDF vectors: {complement_performances['subset']['TF + TF-IDF']}
                - Splitting with `train_test_split`:
                    - TF vectors: {complement_performances['train_test_split']['TF']}
                    - TF-IDF vectors: {complement_performances['train_test_split']['TF-IDF']}
                    - TF + TF-IDF vectors: {complement_performances['train_test_split']['TF + TF-IDF']}
                '''
            )
    st.subheader('')
    ...
    # --------------------------------------------------------------------
    run_button_key = 'newsgroups_tuning_train_size_run_button'  
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        accuracy_df, fig = tuning_train_size()
    ...
    # -----------------------------------------------------
    run_button_key = 'newsgroups_tuning_ngram_range_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        def tuning_ngram_range():
            ...
            return accuracy_df, fig1, fig2, fig3, fig4, fig5, fig6, fig7, fig8
        
        accuracy_df, fig1, fig2, fig3, fig4, fig5, fig6, fig7, fig8 = tuning_ngram_range()
    ...
    # ---------------------------------------------------------------------
    run_button_key = 'newsgroups_tuning_mindf_maxdf_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        def tuning_mindf_maxdf():
            ...
            return accuracy_df, default_min_df, default_max_df, fig1, fig2, fig3, fig4
        
        accuracy_df, default_min_df, default_max_df, fig1, fig2, fig3, fig4 = tuning_mindf_maxdf()
    ...
    # --------------------------------------------------------------------
    run_button_key = 'newsgroups_tuning_max_features_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        def tuning_max_features():
            ...
            return accuracy_df, fig1, fig2
        
        accuracy_df, fig1, fig2 = tuning_max_features()
    ...
    # -----------------------------------------------------------------
    run_button_key = 'newsgroups_tuning_tfidfvectorizer_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        def tuning_tfidfvectorizer():
            ...
            multinomial_styled_df = accuracy_df[accuracy_df['Classifier']=='Multinomial'].sort_values(by='TF-IDF accuracy', ascending=False).style.apply(custom_style, axis=1).background_gradient(cmap='viridis', axis=0, subset='TF-IDF accuracy')

            complement_styled_df = accuracy_df[accuracy_df['Classifier']=='Complement'].sort_values(by='TF-IDF accuracy', ascending=False).style.apply(custom_style, axis=1).background_gradient(cmap='viridis', axis=0, subset='TF-IDF accuracy')

            color_styled_df = color_df.style.apply(color_guide_style, axis=1)

            return multinomial_styled_df, complement_styled_df, color_styled_df
        
        multinomial_styled_df, complement_styled_df, color_styled_df = tuning_tfidfvectorizer()
        ...
        with output_col1:
            ...
            st.dataframe(multinomial_styled_df, height=1000)
        with output_col2:
            st.subheader('**Complement classifier accuracy dataframe:**')
            st.dataframe(complement_styled_df, height=1000)
        st.subheader('**Color guide:**')
        st.write(color_styled_df)
    st.subheader('')
    ...
    # --------------------------------------------------------------
    run_button_key = 'newsgroup_classify_samples_into_categories_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        @st.cache(hash_funcs={mpl.figure.Figure: lambda _: None})
        def classify_samples_into_categories_1_step():
            # Load and split the data
            newsgroups_train, newsgroups_test = load_and_split_newsgroups(0.75)
        ...
        metrics, fig1, fig2 = classify_samples_into_categories_1_step()
    ...
    # -----------------------------------------------------------------
    run_button_key = 'newsgroup_classify_samples_into_topics_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        @st.cache(hash_funcs={mpl.figure.Figure: lambda _: None})
        def classify_samples_into_topics_2_step_step_1():
        ...
        metrics, fig1, fig2 = classify_samples_into_topics_2_step_step_1()
    ...
    # --------------------------------------------------------------------
    run_button_key = 'newsgroup_classify_topics_into_categories_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        @st.cache(hash_funcs={mpl.figure.Figure: lambda _: None}, suppress_st_warning=True)
        def classify_topics_into_categories_2_step_step_2():
            ...
            with st.spinner('Training individual topic to categories classifiers...'):
                ...
                for topic in topics_list:
                    if topic != 'Miscellaneous':
                        ...
                        metrics_dict[topic] = metrics
                        figs_dict[topic] = (fig1, fig2)
            ...
            return topics_list, metrics_dict, figs_dict, accuracy_df, fig

        topics_list, metrics_dict, figs_dict, accuracy_df, fig = classify_topics_into_categories_2_step_step_2()

        for topic in topics_list:
            if topic != 'Miscellaneous':

                metrics = metrics_dict[topic]
                fig1, fig2 = figs_dict[topic]
    ...
    # ----------------------------------------------------------------------
    run_button_key = 'newsgroup_two_step_classification_run_button'
    st.subheader('Code:')
    code_col, button_col = st.beta_columns([10,1])
    with code_col:
        code_expander = st.beta_expander('Expand code')
    ...
    if run_button or st.session_state[run_button_key+'_dict']['was_pressed']:
        ...
        @st.cache(hash_funcs={mpl.figure.Figure: lambda _: None}, suppress_st_warning=True)
        def two_step_classification_combined():
        ...
        metrics, fig1, fig2 = two_step_classification_combined()
